...
def test_music_libary_format_nicely():
    music_libary = MusicLibrary(1, "Test Title", 2009, 1)
    assert str(music_libary) == "Music Library(1, Test Title, 2009, 1)"
...
def test_books_are_equal():
    album1 = MusicLibrary(1, "Test Title", 2009, 1)
    album2 = MusicLibrary(1, "Test Title", 2009, 1)
